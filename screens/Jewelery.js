...
import { Appbar, useTheme,Badge,Text } from "react-native-paper";
...
const Jewelery = () => {
  ...
  const getData = async (text) => {
    try {
      const response = await GetDataApi.getJeweleryData();
  ...
  return (
    ...
    >
      <Appbar  style={{ height: 50, backgroundColor: theme.colors.background}}>
        ...
        />
        <Appbar.Content title="Jwelery" titleStyle={{ fontSize: 18 }} />
