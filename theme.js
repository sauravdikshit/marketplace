...
export const  CombinedDefaultTheme = {
  ...
  colors: {
    ...
    avatarimage:"rgb(0, 110, 0)",
    cardcolor: "rgb(rgb(255, 255, 255))",
    buttoncolor: "rgb(255, 255, 255)",
    accountbtncolor:"rgb(255, 255, 255)",
    statusbarcolor: "rgb(0, 0, 0)",
    bottomsheethandle:"#00000040"
  },
};
...
export const CombinedDarkTheme = {
  ...
  colors: {
    ...
    primary:"rgb(114, 222, 94)",
      ...
      backdrop: "rgba(44, 50, 41, 0.4)",
      avatarpimage:"rgb(255, 255, 255)",
      cardcolor: "rgb(38, 55, 34)",
      buttoncolor: "rgb(26, 28, 24)",
      accountbtncolor:"rgb(0, 110, 0)",
      statusbarcolor:"rgb(255, 255, 255)",
      bottomsheethandle:"rgb(141, 251, 119)"
